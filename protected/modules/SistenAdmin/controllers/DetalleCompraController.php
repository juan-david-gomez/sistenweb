...
class DetalleCompraController extends AweController
{
	/**
	...
	public function actionCreate()
	{
		...
		$model->id_compra = isset($_GET['id_compra'])?$_GET['id_compra']:"";

        $this->performAjaxValidation($model, 'detalle-compra-form');
