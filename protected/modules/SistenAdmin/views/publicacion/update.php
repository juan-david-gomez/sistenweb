...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->id_publicacion) => array('view', 'id'=>$model->id_publicacion),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->id_publicacion)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . Publicacion::label(); ?> <?php echo CHtml::encode($model) ?></legend>
