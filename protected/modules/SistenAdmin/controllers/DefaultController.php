...
class DefaultController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('create','admin','update','logout'),
				'users'=>array('@'),
			),
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('login'),
	...
	public function actionIndex()
	{
		...
		{
			$this->redirect(Yii::app()->createUrl('SistenAdmin/default/admin'));
		}
	}
	...
	public function actionLogin()
	{
		...
		}else
		{
				...
				Yii::app()->user->setFlash('error', "Ingrese sus credenciales");
		}
	...
	{
		Yii::app()->user->logout();
		$this->redirect(Yii::app()->createUrl('SistenAdmin/'));
	}
