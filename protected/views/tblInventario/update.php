...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->id_inventario) => array('view', 'id'=>$model->id_inventario),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->id_inventario)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . TblInventario::label(); ?> <?php echo CHtml::encode($model) ?></legend>
